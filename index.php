...
<html>
    <head>
        ...
        <title>Drabužių parduotuvė</title>
        ...
        <table class="center" ><tr><td>
            ...
            if ($session->logged_in) {
                ...
                <div style="text-align: center;color:white">
                    <br><br>
                    <h1>Drabužių parduotuvė. <br> Šiuolaiški drabužiai visiems: dideliems ir mažiems!</h1><br>
					<h2>Naujovė: galimybė užsisakyti norimą prekę iš anskto.</h2><br>
					<h3>Sekite naujienas apie ateinančias akcijas!</h3>
                </div><br>
                <?
